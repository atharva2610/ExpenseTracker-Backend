...
urlpatterns = [
    ...
    # path('tags/', tags, name="tags"), # tags are under development, so hiding the list view for now
    path('create-tag/', create_tag, name="create_tag"),
    path('update-tag/<uuid:id>/', update_tag, name="update_tag"),
    path('transactions/', transactions, name="transactions"),
    path('transactions/fund-account/<uuid:fund_acct_id>/', transactions_by_fund_account, name="transactions_by_fund_account"),
    path('transactions/category/<uuid:category_id>/', transactions_by_category, name="transactions_by_category"),
